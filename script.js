...
try {
    ...
    const supabaseApplications = Array.isArray(data)
        ? data.map((app) => ({
            ...
            longDescription: app.long_description || app.description || 'No detailed description available.',
            version: app.version || 'Unknown version',
            size: app.size || 'Unknown size',
            source: app.source || 'F-Droid',
            license: app.license || 'Unknown license',
            platform: app.platform || 'Android',
            category: app.category || 'Other',
            added: app.added || app.created_at || new Date(0).toISOString(),
